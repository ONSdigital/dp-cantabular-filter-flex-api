...
func (c *Component) cantabularReturnsMultipleDimensions(datasetID string, docs *godog.DocString) error {
...
>>>>>>> ef76bb8 (test: ammend/add tests for multivariate support)
